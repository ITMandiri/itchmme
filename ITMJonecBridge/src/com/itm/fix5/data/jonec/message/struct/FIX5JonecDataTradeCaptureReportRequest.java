 ...
 * @author fredy
 */
public class FIX5JonecDataTradeCaptureReportRequest extends FIX5JonecDataHeader {

    //.reference name: TradeCaptureReportRequest(AD)
    ...
    public FIX5JonecDataTradeCaptureReportRequest(Map<String, ArrayList<String>> inputMsgFields) {
