 ...
 * @author aripam
 */
public class FIX5JonecDataHeartbeat extends FIX5JonecDataHeader {

    //.reference name: Heartbeat (0)

    //.fields:
    private String fTestReqID = "";

    public FIX5JonecDataHeartbeat(Map<String, ArrayList<String>> inputMsgFields) {
