 ...
 * @author aripam
 */
public class FIX5JonecDataMassQuote extends FIX5JonecDataHeader {

    //.reference name: Mass Quote (i)
    ...
    public FIX5JonecDataMassQuote(Map<String, ArrayList<String>> inputMsgFields) {
