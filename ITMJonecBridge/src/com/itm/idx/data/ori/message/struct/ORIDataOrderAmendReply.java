 ...
 * @author aripam
 */
public class ORIDataOrderAmendReply extends ORIDataHeader{

    //.enums:
    public enum ORIOrderAmendReplyType{
        OK,
        BAD
    }
    ...
    private ORIOrderAmendReplyType fOrderAmendReplyType;
    
    public ORIDataOrderAmendReply(Map<String, String> inputMsgFields) {
    ...
    public ORIOrderAmendReplyType getfOrderAmendReplyType() {
        return fOrderAmendReplyType;
    }

    public void setfOrderAmendReplyType(ORIOrderAmendReplyType fOrderAmendReplyType) {
        this.fOrderAmendReplyType = fOrderAmendReplyType;
    }
    ...
    public String msgDataToString() {
        ...
        try{
            ...
            if (null != getfOrderAmendReplyType())switch (getfOrderAmendReplyType()) {
                case OK:
