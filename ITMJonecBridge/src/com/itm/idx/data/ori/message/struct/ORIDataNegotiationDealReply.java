 ...
 * @author aripam
 */
public class ORIDataNegotiationDealReply extends ORIDataHeader {

    //.enums:
    public enum ORINegotiationDealReplyType{
        ReplyOK,
        ReplyBAD,
        ConfirmationOK //.tidak terpakai, jadi satu dengan reply OK.
        //ConfirmationBAD //.tidak terpakai, jadi satu dengan reply BAD.
    }
    ...
    private ORINegotiationDealReplyType fNegotiationDealReplyType;
    
    public ORIDataNegotiationDealReply(Map<String, String> inputMsgFields) {
    ...
    public ORINegotiationDealReplyType getfNegotiationDealReplyType() {
        return fNegotiationDealReplyType;
    }

    public void setfNegotiationDealReplyType(ORINegotiationDealReplyType fNegotiationDealReplyType) {
        this.fNegotiationDealReplyType = fNegotiationDealReplyType;
    }
    ...
    public String msgDataToString() {
        ...
        try{
            ...
            if (null != getfNegotiationDealReplyType())switch (getfNegotiationDealReplyType()) {
                case ReplyOK:
                case ConfirmationOK:
