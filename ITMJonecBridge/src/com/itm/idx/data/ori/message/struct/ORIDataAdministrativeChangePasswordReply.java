 ...
 * @author aripam
 */
public class ORIDataAdministrativeChangePasswordReply extends ORIDataHeader {

    //.enums:
    public enum ORIAdministrativeChangePasswordReplyType{
        OK,
        BAD
    }
    ...
    private ORIAdministrativeChangePasswordReplyType fAdministrativeChangePasswordReplyType;
    
    public ORIDataAdministrativeChangePasswordReply(Map<String, String> inputMsgFields) {
    ...
    public ORIAdministrativeChangePasswordReplyType getfAdministrativeChangePasswordReplyType() {
        return fAdministrativeChangePasswordReplyType;
    }

    public void setfAdministrativeChangePasswordReplyType(ORIAdministrativeChangePasswordReplyType fAdministrativeChangePasswordReplyType) {
        this.fAdministrativeChangePasswordReplyType = fAdministrativeChangePasswordReplyType;
    }
    ...
    public String msgDataToString() {
        ...
        try{
            ...
            sb.append(getfCurrentPassword()).append(ORIDataConst.ORIFieldFmt.FIELD_SEPARATOR);
            sb.append(ORIDataConst.ORIFieldTag.NEWPASSWORD).append(ORIDataConst.ORIFieldFmt.KV_SEPARATOR);
            sb.append(getfNewPassword()).append(ORIDataConst.ORIFieldFmt.FIELD_SEPARATOR);
    ...
    public String msgToString() {
        ...
        try{
            ...
            if (StringHelper.isNullOrEmpty(getfMsgType())){
                setfMsgType(ORIDataConst.ORIMsgType.CHANGE_PASSWORD);
            }
