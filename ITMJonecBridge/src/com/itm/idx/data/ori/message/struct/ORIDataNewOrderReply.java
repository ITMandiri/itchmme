 ...
 * @author aripam
 */
public class ORIDataNewOrderReply extends ORIDataHeader {

    //.enums:
    public enum ORINewOrderReplyType{
        OK,
        BAD,
        Matched
    }
    ...
    private ORINewOrderReplyType fNewOrderReplyType;
    
    public ORIDataNewOrderReply(Map<String, String> inputMsgFields) {
    ...
    public ORINewOrderReplyType getfNewOrderReplyType() {
        return fNewOrderReplyType;
    }

    public void setfNewOrderReplyType(ORINewOrderReplyType fNewOrderReplyType) {
        this.fNewOrderReplyType = fNewOrderReplyType;
    }
    ...
    public String msgDataToString() {
        ...
        try{
            ...
            if (null != getfNewOrderReplyType())switch (getfNewOrderReplyType()) {
                case OK:
