 ...
 * @author aripam
 */
public class ORIDataOrderCancelReply extends ORIDataHeader {

    //.enums:
    public enum ORIOrderCancelReplyType{
        OK,
        BAD
    }
    ...
    private ORIOrderCancelReplyType fOrderCancelReplyType;
    
    public ORIDataOrderCancelReply(Map<String, String> inputMsgFields) {
    ...
    public ORIOrderCancelReplyType getfOrderCancelReplyType() {
        return fOrderCancelReplyType;
    }

    public void setfOrderCancelReplyType(ORIOrderCancelReplyType fOrderCancelReplyType) {
        this.fOrderCancelReplyType = fOrderCancelReplyType;
    }
    ...
    public String msgDataToString() {
        ...
        try{
            ...
            if (null != getfOrderCancelReplyType())switch (getfOrderCancelReplyType()) {
                case OK:
