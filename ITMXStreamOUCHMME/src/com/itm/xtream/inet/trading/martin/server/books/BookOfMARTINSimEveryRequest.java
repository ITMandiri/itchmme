 ...
 * @author fredy
 */
public class BookOfMARTINSimEveryRequest {
    //.single instance:
    public final static BookOfMARTINSimEveryRequest getInstance = new BookOfMARTINSimEveryRequest();
    
    public final static String BACKUP_CODE = "BOOK_OF_MARTIN_SIM_EVERY_REQUEST";
    
    public ITMMapBackupProcessor backupProcessor;
    
    private final ConcurrentHashMap<Long, SheetOfMARTINSimEveryRequest> chmSheets = new ConcurrentHashMap<>();
    
    public BookOfMARTINSimEveryRequest() {
        ////backupProcessor = ITMMapBackupMgr.getInstance.getOrCreateBackupProcessor(BACKUP_CODE, true, false, chmSheets, Long.class, SheetOfMARTINSimEveryRequest.class);
    ...
    public boolean addOrUpdateSheet(SheetOfMARTINSimEveryRequest mSheet){
        boolean mOut = false;
        try{
    ...
    public ConcurrentHashMap<Long, SheetOfMARTINSimEveryRequest> retrieveAllSheets(){
        return this.chmSheets;
    }
    
    public SheetOfMARTINSimEveryRequest retrieveSheet(Long vOrderId){
        SheetOfMARTINSimEveryRequest mOut = null;
        try{
