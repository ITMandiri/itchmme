 ...
 * @author fredy
 */
public class JONECSimMsgMemWorkSystemEvent {
    //.single instance:
    public final static JONECSimMsgMemWorkSystemEvent getInstance = new JONECSimMsgMemWorkSystemEvent();
    
    public JONECSimMsgMemWorkSystemEvent() {
        //.nothing todo here:)
    ...
    //.soon
//    public void doWork(SheetOfOUCHBase mSheet, OUCHMsgSystemEvent mMessage){
//        try{
//            
//        }catch(Exception ex0){
