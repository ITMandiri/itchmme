 ...
 * @author fredy
 */
public class JONECSimWorkDataLiquidityProviderOrderCancel {
    //.single instance:
    public final static JONECSimWorkDataLiquidityProviderOrderCancel getInstance = new JONECSimWorkDataLiquidityProviderOrderCancel();
    
    public JONECSimWorkDataLiquidityProviderOrderCancel() {
        //.nothing todo here:)
    ...
    public void doWork(ITMSocketChannel channel, ORIDataLiquidityProviderOrderCancel mInputMsgRequest){
        try{
