 ...
 * @author fredy
 */
public class BookOfJONECSimOriginRequest {
    //.single instance:
    public final static BookOfJONECSimOriginRequest getInstance = new BookOfJONECSimOriginRequest();
    
    public final static String BACKUP_CODE = "BOOK_OF_JONEC_SIM_ORIGIN_REQUEST";
    
    public ITMMapBackupProcessor backupProcessor;
    
    private final ConcurrentHashMap<Long, SheetOfJONECSimOriginRequest> chmSheets = new ConcurrentHashMap<>();
    
    public BookOfJONECSimOriginRequest() {
        ////backupProcessor = ITMMapBackupMgr.getInstance.getOrCreateBackupProcessor(BACKUP_CODE, true, false, chmSheets, Long.class, SheetOfJONECSimOriginRequest.class);
    ...
    public boolean addOrUpdateSheet(SheetOfJONECSimOriginRequest mSheet){
        boolean mOut = false;
        try{
    ...
    public ConcurrentHashMap<Long, SheetOfJONECSimOriginRequest> retrieveAllSheets(){
        return this.chmSheets;
    }
    
    public SheetOfJONECSimOriginRequest retrieveSheet(Long vOrderId){
        SheetOfJONECSimOriginRequest mOut = null;
        try{
