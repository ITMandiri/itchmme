 ...
 * @author fredy
 */
public class FIX5JonecWorkDataReject {
    //.single instance:
    public final static FIX5JonecWorkDataReject getInstance = new FIX5JonecWorkDataReject();
    
    public FIX5JonecWorkDataReject() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataReject mInputMsgRequest){
        try{
            if (controller != null){
