 ...
 * @author fredy
 */
public class FIX5JonecWorkDataOrderCancelReplaceRequest {
    //.single instance:
    public final static FIX5JonecWorkDataOrderCancelReplaceRequest getInstance = new FIX5JonecWorkDataOrderCancelReplaceRequest();
    
    public FIX5JonecWorkDataOrderCancelReplaceRequest() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataOrderCancelReplaceRequest mInputMsgRequest){
        try{
