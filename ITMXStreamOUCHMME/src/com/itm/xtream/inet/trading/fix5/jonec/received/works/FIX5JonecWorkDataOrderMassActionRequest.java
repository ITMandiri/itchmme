 ...
 * @author fredy
 */
public class FIX5JonecWorkDataOrderMassActionRequest {
    //.single instance:
    public final static FIX5JonecWorkDataOrderMassActionRequest getInstance = new FIX5JonecWorkDataOrderMassActionRequest();
    
    public FIX5JonecWorkDataOrderMassActionRequest() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataOrderMassActionRequest mInputMsgRequest){
        try{
