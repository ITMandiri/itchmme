 ...
 * @author fredy
 */
public class FIX5JonecWorkDataRequestforPositions {
    //.single instance:
    public final static FIX5JonecWorkDataRequestforPositions getInstance = new FIX5JonecWorkDataRequestforPositions();
    
    public FIX5JonecWorkDataRequestforPositions() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataRequestforPositions mInputMsgRequest){
        try{
