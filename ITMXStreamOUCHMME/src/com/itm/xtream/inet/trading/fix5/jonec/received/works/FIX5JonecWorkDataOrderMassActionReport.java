 ...
 * @author fredy
 */
public class FIX5JonecWorkDataOrderMassActionReport {
    //.single instance:
    public final static FIX5JonecWorkDataOrderMassActionReport getInstance = new FIX5JonecWorkDataOrderMassActionReport();
    
    public FIX5JonecWorkDataOrderMassActionReport() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataOrderMassActionReport mInputMsgRequest){
        try{
