 ...
 * @author fredy
 */
public class FIX5JonecWorkDataMassQuoteAcknowledgement {
    //.single instance:
    public final static FIX5JonecWorkDataMassQuoteAcknowledgement getInstance = new FIX5JonecWorkDataMassQuoteAcknowledgement();
    
    public FIX5JonecWorkDataMassQuoteAcknowledgement() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataMassQuoteAcknowledgement mInputMsgRequest){
        try{
