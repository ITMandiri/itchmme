 ...
 * @author fredy
 */
public class FIX5JonecWorkDataBusinessMessageReject {
    //.single instance:
    public final static FIX5JonecWorkDataBusinessMessageReject getInstance = new FIX5JonecWorkDataBusinessMessageReject();
    
    public FIX5JonecWorkDataBusinessMessageReject() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataBusinessMessageReject mInputMsgRequest){
        try{
            if (controller != null){
