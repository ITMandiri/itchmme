 ...
 * @author fredy
 */
public class FIX5JonecWorkDataPositionReport {
    //.single instance:
    public final static FIX5JonecWorkDataPositionReport getInstance = new FIX5JonecWorkDataPositionReport();
    
    public FIX5JonecWorkDataPositionReport() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataPositionReport mInputMsgRequest){
        try{
            if (controller != null){
