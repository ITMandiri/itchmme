 ...
 * @author fredy
 */
public class FIX5JonecWorkDataMassQuote {
    //.single instance:
    public final static FIX5JonecWorkDataMassQuote getInstance = new FIX5JonecWorkDataMassQuote();
    
    public FIX5JonecWorkDataMassQuote() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataMassQuote mInputMsgRequest){
        try{
