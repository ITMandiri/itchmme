 ...
 * @author fredy
 */
public class FIX5JonecWorkDataSequenceReset {
    //.single instance:
    public final static FIX5JonecWorkDataSequenceReset getInstance = new FIX5JonecWorkDataSequenceReset();
    
    public FIX5JonecWorkDataSequenceReset() {
        //.nothing todo here:)
        ITMFileLoggerManager.getInstance.insertLog(this, logSource.XTTS, logLevel.INIT, "");
    }
    
    public void doWork(ITMSocketChannel channel, FIX5IDXBridgeController controller, FIX5JonecDataSequenceReset mInputMsgRequest){
        try{
