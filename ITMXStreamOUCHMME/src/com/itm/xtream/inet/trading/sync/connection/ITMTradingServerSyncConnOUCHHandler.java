 ...
 * @author fredy
 */
public class ITMTradingServerSyncConnOUCHHandler implements ITMSoupBinTCPBridgeSocketListener {

    @Override
    public void onConnected(ITMSoupBinTCPBridgeSocketChannel channel) {
        ///throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ITMTradingServerSyncConnectionMgr.getInstance.broadCastServerRGStatusToMartin(true);
    }
    ...
    public void onDisconnected(ITMSoupBinTCPBridgeSocketChannel channel) {
        ...
        ITMTradingServerSyncConnectionMgr.getInstance.broadCastServerRGStatusToMartin(false);
    }
