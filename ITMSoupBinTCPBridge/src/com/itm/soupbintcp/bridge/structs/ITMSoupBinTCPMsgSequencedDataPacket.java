 ...
 * @author Ari Pambudi
 */
public class ITMSoupBinTCPMsgSequencedDataPacket extends ITMSoupBinTCPMsgBase {
    
    private byte[] Message                                                      = new byte[]{};
    
    private long SelfSequencedNo                                                = 0;

    public ITMSoupBinTCPMsgSequencedDataPacket(){
        super.setPacketType(ITMSoupBinTCPBridgeConsts.SoupBinTCPPacketType.PACKETTYPE_SEQUENCED_DATA_PACKET);
    }
    ...
    public long getSelfSequencedNo() {
        return SelfSequencedNo;
    }

    public void setSelfSequencedNo(long SelfSequencedNo) {
        this.SelfSequencedNo = SelfSequencedNo;
    }
