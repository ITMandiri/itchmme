 ...
 * @author Ari Pambudi
 */
public class ITMSoupBinTCPMsgLoginRejectPacket extends ITMSoupBinTCPMsgBase {
    
    private String RejectReasonCode                                             = "";

    public ITMSoupBinTCPMsgLoginRejectPacket(){
        super.setPacketType(ITMSoupBinTCPBridgeConsts.SoupBinTCPPacketType.PACKETTYPE_LOGIN_REJECTED_PACKET);
    }
    ...
    public byte[] buildPacket(){
        ...
        .concatenateField(getRejectReasonCode(), 3, 1)
    ...
    public boolean parsePacket(byte[] btPacketBytes) {
        ...
        try{
            if (super.parsePacket(btPacketBytes)){
                ...
                setRejectReasonCode(decodeStringTrim(btPacketBytes, 3, 1));
