 ...
 * @author Ari Pambudi
 */
public class ITMSoupBinTCPMsgServerHeartbeatPacket extends ITMSoupBinTCPMsgBase {
    //.nofield;
    
    public ITMSoupBinTCPMsgServerHeartbeatPacket(){
        super.setPacketType(ITMSoupBinTCPBridgeConsts.SoupBinTCPPacketType.PACKETTYPE_SERVER_HEARTBEAT_PACKET);
    }
