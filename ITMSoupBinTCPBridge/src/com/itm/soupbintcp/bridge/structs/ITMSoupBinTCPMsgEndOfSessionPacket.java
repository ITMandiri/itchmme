 ...
 * @author Ari Pambudi
 */
public class ITMSoupBinTCPMsgEndOfSessionPacket extends ITMSoupBinTCPMsgBase {
    //.nofield;
    
    public ITMSoupBinTCPMsgEndOfSessionPacket(){
        super.setPacketType(ITMSoupBinTCPBridgeConsts.SoupBinTCPPacketType.PACKETTYPE_END_OF_SESSION_PACKET);
    }
