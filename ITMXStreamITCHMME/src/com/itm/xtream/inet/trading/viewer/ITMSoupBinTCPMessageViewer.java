...
public class ITMSoupBinTCPMessageViewer extends javax.swing.JPanel {
    ...
    private final static String MODULE_CODE_ITCH_MDF = "MDF";
    
    private final static String MODULE_JSON_FILE_NAME_ITCH = "itch_messages.json";
    private final static String MODULE_JSON_FILE_NAME_ITCH_MDF = "itch_mdf_messages.json";
        ...
        try{
            if ((moduleCode != null) && (!moduleCode.isEmpty())
                && (
                    ...
                    || (MODULE_CODE_ITCH_MDF.equalsIgnoreCase(moduleCode))
                )
            ){
                String zLocalPath = "./";
                /**********
                ...
                **********/
                ...
                while(!bCheckModuleFileFound){
                    ...
                    switch(moduleCode){
                        case MODULE_CODE_ITCH_MDF:
                            zCheckModuleFilePath += MODULE_JSON_FILE_NAME_ITCH_MDF;
                            break;
                        ...
                        if ((this.moduleJSON != null) && (!this.moduleJSON.isEmpty())){
                            ...
                            switch(moduleCode){
                                case MODULE_CODE_ITCH_MDF:
                                    ...
                                    break;
                                case MODULE_CODE_ITCH:
                                    mDynITCHMsg = ITMSoupBinTCPDynStructParser.getInstance.parseITCHPacket(mEachBackupMsg.arbMessage, mEachBackupMsg.isOutput, (mEachBackupMsg.recordNo > 0), this.moduleDynStructObj);
                                    if (mDynITCHMsg != null){
                                        mEachBackupMsg.dynMessage = mDynITCHMsg;
                                    }
                                    break;
            ...
            try{
                if (isForField){
                    if ((mMsg.dynMessage.msg.fields != null) && (mMsg.dynMessage.msg.fields.length > this.pFieldIndex)){
                        mOut = "" + mMsg.dynMessage.msg.fields[this.pFieldIndex].name 
                                + " [" + mMsg.dynMessage.msg.fields[this.pFieldIndex].type + "] = " 
                                + ( ( (mMsg.dynMessage.msg.fields[this.pFieldIndex].type.equalsIgnoreCase("Integer")) || (mMsg.dynMessage.msg.fields[this.pFieldIndex].type.equalsIgnoreCase("Token")) ) 
                                ? mMsg.dynMessage.msg.fields[this.pFieldIndex].msglongval 
                                : (mMsg.dynMessage.msg.fields[this.pFieldIndex].type.equalsIgnoreCase("Price")) 
                                ? mMsg.dynMessage.msg.fields[this.pFieldIndex].msgdoubleval
                                : mMsg.dynMessage.msg.fields[this.pFieldIndex].msgstrval);
                    }else{
